...
namespace MVC5Garden.Controllers
{
    ...
    /// 
    /// This assembly defines some core interfaces that are used by mvc and webapi to manage identity.
    /// 
    /// IUser
    ...
    /// 
    /// UserManager
    /// Takes an object that implements the IUserStore interface. Used to validate usernames and password, hashes passwords. Validates identities. This is what is used by the controllers.
    /// 
    /// Role Manager
    /// ...
    /// 
    /// For SQL server these interfaces have already been implemented. For MongoDB, XML, or any other type of persistence these interfaces need to be implemented with an alternative approach.
    /// </summary>
    [Authorize]
